...
def grid_search_RL(Q, mode):
    alpha_values = [0.001, 0.01, 0.1, 0.2]
    gamma_values = [0.8, 0.85, 0.9, 0.95, 0.99]

    # mc_control best_avg_reward: 8.35
    # mc_control best_params: {'alpha': 0.001, 'gamma': 0.9}

    # q_learning best_avg_reward: 8.39
    # q_learning best_params: {'alpha': 0.1, 'gamma': 0.8}
    ...
    print(f"{mode} best_avg_reward: " + str(best_avg_reward))
    print(f"{mode} best_params: " + str(best_params))
...
while True:
    ...
    print("2. MC-control")
    print("3. q-learning")
    print("4. Grid-Search MC-control")
    print("5. Grid-Search q-learning")
    print("6. exit")
